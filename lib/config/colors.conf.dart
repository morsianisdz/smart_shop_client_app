...
class ColorsConf {
  static Color orange = const Color(0xFFFF6B00);
  ...
  static Color textlightGray = const Color(0xFF9CA3AF);
  ...
  static Color lightContainer2 = const Color.fromARGB(255, 234, 235, 236);
